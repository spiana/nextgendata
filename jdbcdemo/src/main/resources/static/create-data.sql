...
create table customer(pk bigint default customer_seq.nextval primary key , first_name varchar(255) , last_name varchar(255));
insert into customer values(1,'sergio' , 'piana');
...
create table customer_ext(pk bigint default customer1_seq.nextval primary key , custom1 varchar(255) , custom2 varchar(255) , customer_id bigint);
insert into customer_ext values(1,'custom1' , 'custom2' , 1);

create table customer_ext1(pk bigint default customer2_seq.nextval primary key , custom3 varchar(255) , custom4 varchar(255) , customer_id bigint);
